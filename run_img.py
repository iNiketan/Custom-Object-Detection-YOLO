...
ap.add_argument('-c', '--config',
                help = 'path to yolo config file', default='custom/yolov3-tiny-custom.cfg')
ap.add_argument('-w', '--weights',
                help = 'path to yolo pre-trained weights', default='custom/yolov3-tiny-custom_30000.weights')
ap.add_argument('-cl', '--classes',
                help = 'path to text file containing class names',default='custom/objects.names')
ap.add_argument('-i', '--images', help = 'image to analysis')
args = ap.parse_args()
